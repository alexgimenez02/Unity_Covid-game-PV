namespace TurnTheGameOn.ArrowWaypointer
{
	...
	public class WaypointController : MonoBehaviour
	{
        ...
        void Update () {
			...
			if (arrowTarget != null) {
				arrowTarget.localPosition = Vector3.Lerp (arrowTarget.localPosition, currentWaypoint.localPosition, 0);
				arrowTarget.localRotation = Quaternion.Lerp (arrowTarget.localRotation, currentWaypoint.localRotation, 0);
			} else {
